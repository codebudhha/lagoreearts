...
export function createApp() {
  ...
  app.get('/order-confirmation.html', (req, res) => res.sendFile(path.join(rootDir, 'Order Confirmation - Lagoree Arts.html')));
  app.get('/confirmation', (req, res) => res.sendFile(path.join(rootDir, 'Order Confirmation - Lagoree Arts.html')));
  app.get('/confirmation.html', (req, res) => res.sendFile(path.join(rootDir, 'Order Confirmation - Lagoree Arts.html')));
  app.get('/thank-you', (req, res) => res.sendFile(path.join(rootDir, 'Order Confirmation - Lagoree Arts.html')));
  app.get('/thank-you.html', (req, res) => res.sendFile(path.join(rootDir, 'Order Confirmation - Lagoree Arts.html')));
  app.get('/order-success', (req, res) => res.sendFile(path.join(rootDir, 'Order Confirmation - Lagoree Arts.html')));
  app.get('/order-success.html', (req, res) => res.sendFile(path.join(rootDir, 'Order Confirmation - Lagoree Arts.html')));
  app.get('/order-detail', (req, res) => res.sendFile(path.join(rootDir, 'Order Detail - Lagoree Arts.html')));
  app.get('/order-detail.html', (req, res) => res.sendFile(path.join(rootDir, 'Order Detail - Lagoree Arts.html')));
